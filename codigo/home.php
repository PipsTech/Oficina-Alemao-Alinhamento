            ...
            <div class="col">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="bateria.jfif" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="oleo.webp" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="pastilha de freio.jfif" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="alinhamento.jfif" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="balanceamento.jfif" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            <img class="card-img-top" src="troca de freio.jfif" alt="Card image cap" style="width: 338px; height: 300px;">
                            <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-lg-4 col-xl-3">
                    ...
                    <p class="mb-0">
                        <img class="card-img-top" src="slogan.jfif" alt="Card image cap" style="border-radius: 20px;">
                    </p>
                </div>
