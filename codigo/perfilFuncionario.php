        ...
        <div class="row">
            <div class="col-xl-8 m-auto order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Dados da conta - Funcionário</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="input-username">Primeiro Nome</label>
                                            <a href="#!" class="btn btn-success" style="padding: 2px;">Editar nome</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-last-name">Função</label>
                                            <a href="#!" class="btn btn-success" style="padding: 2px;">Editar função</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="input-telephone">Telefone</label>
                                            <a href="#!" class="btn btn-success" style="padding: 2px;">Editar telefone</a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group focused">
                                            ...
                                            <a href="#!" class="btn btn-success" style="padding: 2px;">Editar senha</a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group focused">
                                            ...
                                            <a href="#!" class="btn btn-success" style="padding: 2px;">Editar email</a>
                                            <input type="email" id="input-email"
                                                class="form-control form-control-alternative"
                                                placeholder="tis3@gmail.com">
                                        </div>
                                    </div>
