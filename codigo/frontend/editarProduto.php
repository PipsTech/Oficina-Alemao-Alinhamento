                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a href="./editarDescricao.php" class="btn btn-success"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <a href="./editarPrecoProduto.php" class="btn btn-success"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <button type="submit" class="btn btn-danger" value="Cadastrar"
                                onclick="javascript: location.href='../backend/excluirproduto.php'">Excluir Produto</button>
                        </div>
                    </div>
