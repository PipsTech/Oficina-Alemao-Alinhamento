                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group focused">
                                        ...
                                        <a href="./editarNomeP.php" class="btn btn-success" style="padding: 2px;">Editar
                                            nome</a>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a href="./editarDescricao.php" class="btn btn-success" style="padding: 2px;">Editar Descrição</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <a href="./editarPrecoProduto.php" class="btn btn-success" style="padding: 2px;">Editar preço</a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="input-password">
                                            <img class="img-fluid" style="width: 338px; height: 300px; " src="data:image/jpeg;base64,<?php
                                                                                                                                        $img = base64_encode($temp['foto_produto']);
                                                                                                                                        echo $img;
                                                                                                                                        ?>"></label>
                                        <a href="./editarImagem.php" class="btn btn-success" style="padding: 2px;">Editar
                                            imagem</a>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="input-email">Quantidade -
                                            <?php
                                            echo $temp['Quantidade'];
                                            ?>
                                        </label>
                                        <a href="./editarQuantidade.php" class="btn btn-success" style="padding: 2px;">Editar
                                            quantidade</a>
                                    </div>
                                </div>
                ...
                <div class="card-header bg-white border-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <button type="submit" class="btn btn-danger" value="Cadastrar" onclick="javascript: location.href='../backend/excluirproduto.php'">Excluir Produto</button>
                        </div>
                    </div>
