    ...
    <div class="row">
        <div class="col-xl-8 m-auto order-xl-1">
            <div class="card bg-secondary shadow">
                <form action="../backend/attSenhaF.php" method="POST">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Senha</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="" class="form-control-label">Digite sua senha atual</label>
                                        <input type="text" name="Confirmar" class="form-control form-control-lg" />

                                        <label for="" class="form-control-label">Digite sua nova senha</label>
                                        <input type="text" name="senha" class="form-control form-control-lg" />

                                        <label for="" class="form-control-label">Confirme sua nova senha</label>
                                        <input type="text" name="Verificar" class="form-control form-control-lg" />
                ...
                <div class="card-header bg-white border-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="./perfilFuncionario.php" class="btn btn-danger">Voltar para o perfil</a>
                        </div>
                    </div>
