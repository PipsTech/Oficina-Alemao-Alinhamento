    ...
    <div class="row">
        <div class="col-xl-8 m-auto order-xl-1">
            <div class="card bg-secondary shadow">
                <form action="../backend/attEmailF.php" method="POST">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Email</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">

                                        <label for="" class="form-control-label">Digite seu email</label>
                ...
                <div class="card-header bg-white border-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="./perfilFuncionario.php" class="btn btn-danger">Voltar para a home</a>
                        </div>
                    </div>
