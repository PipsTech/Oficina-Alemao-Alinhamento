    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="row">
            <div class="col-xl-8 m-auto order-xl-1">
                ...
                <form action="../backend/attAP.php?id=<?php  echo $_REQUEST['id']; ?>" method="POST">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Preço</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6"> 
                                        
                                        <label for="" class="form-control-label">Digite o preço</label>
