    ...
    <div class="row">
        <div class="col-xl-8 m-auto order-xl-1">
            <div class="card bg-secondary shadow">
                <form action="../backend/attImgS.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Imagem</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">

                                        <label for="" class="form-control-label">Insira a imagem do serviço</label>
                ...
                <div class="card-header bg-white border-0">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="./editarServico.php" class="btn btn-danger">Voltar para editar serviço</a>
                        </div>
                    </div>
