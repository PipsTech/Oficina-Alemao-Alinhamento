...
<html lang="pt-br">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="row">
            <div class="col-xl-8 m-auto order-xl-1">
                ...
                <form action="../backend/attFP.php?id=<?php  echo $_REQUEST['id']; ?>" method="POST">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Forma de Pagamento</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6"> 
                                        
                                        <label for="" class="form-control-label">Digite a forma de pagamento</label>
                                          <input type="text" name = "forma" class="form-control form-control-lg" placeholder="Forma de Pagamento"/>
                    ...
                    <div class="card-header bg-white border-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <a href="./agendaEletronica.php" class="btn btn-danger">Voltar para a agenda eletrônica</a>
                            </div>
                        </div>
    ...
    <footer class="text-light" style="height: 490px;">
        <div class="container">
            <div class="row">
