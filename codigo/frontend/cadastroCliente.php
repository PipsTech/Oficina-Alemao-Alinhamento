            ...
            <div class="col-md-9 register-right">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form action="../backend/RegistrarCliente.php" method="POST">
                            <div class="row register-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="primeiro_nome" class="form-control" placeholder="Primeiro nome *" value="" />
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="telefone" minlength="10" maxlength="10" name="txtEmpPhone" class="form-control" placeholder="Telefone *" value="" />
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="confirmar_senha" class="form-control" placeholder="Confirmar senha *" value="" />
                                    </div>
