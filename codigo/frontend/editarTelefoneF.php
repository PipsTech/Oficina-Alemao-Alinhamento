    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
        ...
        <div class="row">
            <div class="col-xl-8 m-auto order-xl-1">
                ...
                <form action="../backend/attTelefoneF.php" method="POST">
                    <div class="card-body">
                        <form class="infos">
                            <h6 class="btn btn-outline-warning text-center" style="align-items: center;">Editar - Telefone</h6>
                            <p></p>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6"> 
                                        
                                        <label for="" class="form-control-label">Digite seu novo Telefone</label>
                                          <input type="text" name = "telefone" class="form-control form-control-lg" />
