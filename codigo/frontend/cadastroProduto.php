...
<html lang="pt-br">
  ...
  <body>
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
        ...
        <form action="../backend/cadP.php" method="POST" enctype="multipart/form-data">
        <div class="container">   
        <div class="row">
            <p></p>
            <div class="col-12">
                <div class="form-group">
                    <p style="margin-top: 10px;font-size: 25px;"><b><u>Nome do produto</u></b></p>
                    <input type="text" name="nome" class="form-control" placeholder="Nome *" value="" />
                </div>
                <div class="form-group">
                    <p style="font-size: 25px;"><b><u>Descrição do produto</u></b></p>
                    <input type="text" name ="descricao" class="form-control" placeholder="Descrição *" value="" />
                </div>
                <div class="form-group">
                    <p style="font-size: 25px;"><b><u>Preço do produto</u></b></p>
                    <input type="text" name="preco" class="form-control" placeholder="Preço *" value="" />
                </div>
                <div class="form-group">
                    <p style="font-size: 25px;"><b><u>Quantidade</u></b></p>
                    <input type="text" name="quantidade" class="form-control" placeholder="Preço *" value="" />
                </div>
                <div class="form-group">
                    <p style="font-size: 25px;"><b><u>Imagem do Produto</u></b></p>
