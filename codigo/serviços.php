            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./produto.php.html">Produtos</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row">     
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><a href="./Serviço.php" title="Ver Serviço">Alinhamento</a></h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><a href="./Serviço.php" title="Ver Serviço">Balanceamento</a></h4>
                                <p class="card-text">Descrição a definir</p>
                                <div class="row">
                                    <div class="col">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><a href="./Serviço.php" title="Ver Serviço">Troca de freio</a></h4>
                                <p class="card-text">Descrição a definir</p>
                                <div class="row">
                                    <div class="col">
